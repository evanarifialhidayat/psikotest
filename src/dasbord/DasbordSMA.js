...
class DasbordSMA extends Component { 
 constructor(props) {
    super(props);  
    this.state = {
    ...
    <ImageBackground   style={styles.container} >   
          ...
          <View style={styles.header}>                
                <Carousel
                    ...
                    data={this.props.LIST_DASBOARD_SMA_CEK_VALUE.dataall}
        ...
        <View style={styles.signupInput}>
              <Grid
                ...
                data={this.props.LIST_DASBOARD_MENU_SMA_CEK_VALUE.dataall}
                itemsPerRow={4}
              />
...
export default  connect(mapStateToProps)(DasbordSMA);
